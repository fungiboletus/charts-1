...
If your ingress controller has the SSL Termination, you should set `proxyAddressForwarding` to `true` or you can add the following env vars in `extraEnvVars`
```yaml
